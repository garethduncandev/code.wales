...
export class HomeComponent {
  ...
  public readonly npmCodeBlockHeight = 10;
  public readonly npmCodeBlockMinWidth = this.npmCodeBlockHeight;
  public readonly npmPadding = this.npmCodeBlockHeight / 4;
  ...
  public readonly gitHubRectStyles = [
    {
      borderRadius: 1,
      color: 'rgb(0, 105, 243)',
      width: this.codeBlockMinWidth,
